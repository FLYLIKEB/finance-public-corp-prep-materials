...
<img src="../assets/downloaded-visual-aids/hash-function.png" alt="해시 함수 구조" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 해시 함수 구조 기반으로 해시 함수 구조 개념을 시각적으로 확인한다.
