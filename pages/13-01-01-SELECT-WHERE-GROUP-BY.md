...
<img src="../assets/downloaded-visual-aids/sql-select-where.png" alt="SQL SELECT-FROM-WHERE 질의 구조" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: SQL SELECT-FROM-WHERE 질의 구조 기반으로 SQL SELECT-FROM-WHERE 질의 구조 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:SQL-Abfrage.png
## 빈출 포인트
