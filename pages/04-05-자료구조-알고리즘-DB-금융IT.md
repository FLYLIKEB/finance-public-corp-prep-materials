...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/b-tree.png" alt="트리 순회 기준" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: B-Tree 구조 기반으로 트리 순회 기준 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:B-tree.svg
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/binary-search-tree.png" alt="이진 검색 트리 구조" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 이진 검색 트리 구조 기반으로 이진 검색 트리 개념을 시각적으로 확인한다.
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/min-heap.png" alt="최소 힙 구조" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 최소 힙 구조 기반으로 힙 자료구조 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Min-heap.png
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/data-structure-types.png" alt="자료구조·알고리즘·DB" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 자료구조 유형 기반으로 자료구조·알고리즘·DB 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Data_Structure.png
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/ai-progression.png" alt="인공지능 단계 구분" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: AI 발전 단계 도식 기반으로 인공지능 단계 구분 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Conscious_Artificial_Superintelligence_(CASI)_Progression.png
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/docker-logo.svg" alt="가상화 기술 계층" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 컨테이너 기반 가상화 예시 기반으로 가상화 기술 계층 개념을 시각적으로 확인한다.
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/insertion-sort.gif" alt="정렬 알고리즘 선택" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 삽입 정렬 예시 기반으로 정렬 알고리즘 선택 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Insertion-sort-example-300px.gif

### 1. 버블 정렬 (Bubble Sort):
- **설명:** 인접한 두 요소를 비교하여 순서가 맞지 않으면 서로 교환하며 정렬하는 방식
- **특징:** 간단하지만 효율성이 낮음 (시간 복잡도: O(n^2))

<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/bubble-sort.gif" alt="버블 정렬 예시" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 버블 정렬 예시 기반으로 버블 정렬 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Bubble-sort-example-300px.gif
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/selection-sort.gif" alt="선택 정렬 예시" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 선택 정렬 예시 기반으로 선택 정렬 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Selection-Sort-Animation.gif
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/insertion-sort.gif" alt="삽입 정렬 예시" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 삽입 정렬 예시 기반으로 삽입 정렬 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Insertion-sort-example-300px.gif
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/quicksort.gif" alt="퀵 정렬 애니메이션" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 퀵 정렬 애니메이션 기반으로 퀵 정렬 개념을 시각적으로 확인한다.
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/merge-sort.gif" alt="병합 정렬 애니메이션" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 병합 정렬 애니메이션 기반으로 병합 정렬 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Merge_sort_animation.gif

### 6. 힙 정렬 (Heap Sort):
- **설명:** 최대 힙 또는 최소 힙을 구성하여 정렬하는 방식
- **특징:** 시간 복잡도 O(n log n), 추가 메모리 사용이 적음

<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/heap-sort.gif" alt="힙 정렬 애니메이션" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 힙 정렬 애니메이션 기반으로 힙 정렬 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Heap_Sort.gif
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/database-table-query.png" alt="데이터베이스 핵심 구조" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 데이터베이스 테이블과 쿼리 예시 기반으로 데이터베이스 핵심 구조 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Database_table_and_query.png
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/raid5-diagram.png" alt="RAID 레벨 핵심" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: RAID 5 패리티 구조 기반으로 RAID 레벨 핵심 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:RAID5diagram.PNG
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/nosql-data-model.webp" alt="NoSQL 데이터 모델" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: NoSQL 데이터 모델 예시 기반으로 NoSQL 데이터 모델 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Moon-modeler-diagram-nosql-data-model.webp
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/software-test-methods.png" alt="블랙박스와 화이트박스 테스트" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 소프트웨어 테스트 방법 비교 기반으로 블랙박스와 화이트박스 테스트 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Software_test_methods.svg
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/hanoi-tower.gif" alt="하노이탑 재귀 구조" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 하노이탑 풀이 애니메이션 기반으로 하노이탑 재귀 구조 개념을 시각적으로 확인한다.
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/cbdc-balance-sheet.png" alt="CBDC 구조" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: CBDC 대차대조표 구조 기반으로 CBDC 구조 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:CBDC_stylized_Balance_Sheet_(Digitales_Zentralbankgeld).png
...
<img src="https://raw.githubusercontent.com/FLYLIKEB/finance-public-corp-prep-materials/main/assets/downloaded-visual-aids/robo-advisory-evolution.jpg" alt="로보어드바이저 흐름" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: 로보어드바이저 디지털 자산관리 발전 흐름 기반으로 로보어드바이저 흐름 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:Robo-Advisory_evolution.jpg
