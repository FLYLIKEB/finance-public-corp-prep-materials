...
<img src="../assets/downloaded-visual-aids/risc-v-instruction-set.png" alt="RISC-V 모듈형 명령어 세트" style="max-height: 360px; width: auto; max-width: 100%;">
> 그림: RISC-V 모듈형 명령어 세트 기반으로 RISC-V 모듈형 명령어 세트 개념을 시각적으로 확인한다.
> 출처: https://commons.wikimedia.org/wiki/File:RISC-V_Modular_Instruction_Set.svg
